...
namespace QREM_UI{
    class ui : public user_interface_dis<QREM>{
    ...
    protected:
        ...
        typedef typename user_interface_dis<QREM>::model_pointer model_pointer;
        typedef typename user_interface_dis<QREM>::element_type element_type;
