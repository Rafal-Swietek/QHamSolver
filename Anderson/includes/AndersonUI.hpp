...
namespace AndersonUI{
    class ui : public user_interface_dis<Anderson>{
    protected:
        double J, Js;
        double w, ws;
        int Jn, wn;
        ...
        typedef typename user_interface_dis<Anderson>::model_pointer model_pointer;
        typedef typename user_interface_dis<Anderson>::element_type element_type;
    public:
		// ----------------------------------- CONSTRUCTORS
		ui() = default;
