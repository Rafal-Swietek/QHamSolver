...
#include "QuadQSun.hpp"
// ----------------------------------------------------------------------------- UI QUANTUM SUN -----------------------------------------------------------------------------

namespace QuadQSunUI{
    class ui : public user_interface_quadratic<QuadQSun>{
    protected:
        double J, Js;
        ...
        typedef typename user_interface_quadratic<QuadQSun>::model_pointer model_pointer;
        typedef typename user_interface_quadratic<QuadQSun>::element_type element_type;
    public:
		// ----------------------------------- CONSTRUCTORS
		ui() = default;
