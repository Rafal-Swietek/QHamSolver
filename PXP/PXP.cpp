...
PXP::PXP(int _BC, unsigned int L, double J, double c, int zzsym, int z1sym, int z2sym, bool use_syms)
{ 
    CONSTRUCTOR_CALL;
...
void PXP::set_hamiltonian_elements(u64 k, elem_ty value, u64 new_idx)
{   
    u64 state;
    elem_ty sym_eig;
...
typename PXP::sparse_matrix PXP::create_local_hamiltonian(int site)
{
...
std::istream& PXP::read(std::istream& os)
{
...
/// @param os input stream to read parameters
std::ostream& PXP::write(std::ostream& os) const
{
